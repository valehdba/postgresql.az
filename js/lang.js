...
(function() {
  ...
  var T = {
    ...
    'feat.kb': { en: 'Knowledge Base', az: 'Bilik Bazası' },
    'feat.kb_desc': { en: 'PostgreSQL best practices, how-to guides, performance tips, and hard-won lessons shared by the community', az: 'İcma tərəfindən paylaşılan PostgreSQL ən yaxşı təcrübələri, təlimatlar, performans məsləhətləri və təcrübədən qazanılmış dərslər' },
    ...
    // -------- Knowledge Base page --------
    'nav.kb': { en: 'Knowledge Base', az: 'Bilik Bazası' },
    'kb.eyebrow': { en: 'AZERPUG · Knowledge Base', az: 'AZERPUG · Bilik Bazası' },
    'kb.hero_title': { en: 'PostgreSQL Best Practices & Guides', az: 'PostgreSQL Ən Yaxşı Təcrübələr və Təlimatlar' },
    'kb.hero_tagline': { en: "Practical, battle-tested PostgreSQL knowledge — performance tuning, security, backups, replication and more. Curated and contributed by the AZERPUG community so the next engineer doesn't have to learn it the hard way.", az: 'Praktik, sınaqdan keçmiş PostgreSQL bilikləri — performans tənzimləməsi, təhlükəsizlik, ehtiyat nüsxələr, replikasiya və daha çox. AZERPUG icması tərəfindən toplanıb və paylaşılıb ki, növbəti mühəndis bunu çətin yolla öyrənməsin.' },
    'kb.cta_contribute': { en: 'Contribute an Article', az: 'Məqalə Əlavə Et' },
    'kb.cta_browse': { en: 'Browse Articles', az: 'Məqalələrə Bax' },
    'kb.stat_articles': { en: 'articles', az: 'məqalə' },
    'kb.stat_topics': { en: 'topics', az: 'mövzu' },
    'kb.stat_contributors': { en: 'contributors', az: 'töhfəçi' },
    'kb.search_ph': { en: 'Search articles, topics, or tags…', az: 'Məqalə, mövzu və ya teq axtar…' },
    'kb.cat_all': { en: 'All', az: 'Hamısı' },
    'kb.cat_performance': { en: 'Performance', az: 'Performans' },
    'kb.cat_security': { en: 'Security', az: 'Təhlükəsizlik' },
    'kb.cat_backup': { en: 'Backup & Recovery', az: 'Ehtiyat və Bərpa' },
    'kb.cat_replication': { en: 'Replication', az: 'Replikasiya' },
    'kb.cat_admin': { en: 'Administration', az: 'Administrasiya' },
    'kb.cat_development': { en: 'Development', az: 'İnkişaf' },
    'kb.cat_monitoring': { en: 'Monitoring', az: 'Monitorinq' },
    'kb.cat_migration': { en: 'Migration', az: 'Miqrasiya' },
    'kb.cat_other': { en: 'Other', az: 'Digər' },
    'kb.featured': { en: 'Featured', az: 'Seçilmiş' },
    'kb.featured_title': { en: 'Featured Articles', az: 'Seçilmiş Məqalələr' },
    'kb.all_title': { en: 'All Articles', az: 'Bütün Məqalələr' },
    'kb.min_read': { en: 'min read', az: 'dəq oxu' },
    'kb.read_article': { en: 'Read article', az: 'Məqaləni oxu' },
    'kb.hide_article': { en: 'Hide article', az: 'Məqaləni gizlət' },
    'kb.further_reading': { en: 'Further reading', az: 'Əlavə oxu' },
    'kb.no_body': { en: 'Full article coming soon.', az: 'Tam məqalə tezliklə.' },
    'kb.contribute_title': { en: 'Contribute an Article', az: 'Məqalə Əlavə Et' },
    'kb.contribute_subtitle': { en: 'Share a best practice with the community', az: 'İcma ilə ən yaxşı təcrübəni paylaşın' },
    'kb.contribute_intro': { en: "Learned something the hard way? Write it up so the next engineer doesn't have to. Submit a best practice, how-to, or lessons-learned article below — we'll review and publish it to the Knowledge Base.", az: 'Nəyisə çətin yolla öyrəndiniz? Onu yazın ki, növbəti mühəndis öyrənməsin. Ən yaxşı təcrübə, təlimat və ya öyrənilmiş dərs məqaləsini aşağıda göndərin — yoxlayıb Bilik Bazasında dərc edəcəyik.' },
    'kb.lbl_title': { en: 'Article Title', az: 'Məqalə Başlığı' },
    'kb.lbl_category': { en: 'Category', az: 'Kateqoriya' },
    'kb.lbl_readmin': { en: 'Read Time (min)', az: 'Oxu Müddəti (dəq)' },
    'kb.lbl_summary': { en: 'Summary', az: 'Xülasə' },
    'kb.lbl_content': { en: 'Article Body', az: 'Məqalənin Mətni' },
    'kb.lbl_content_help': { en: 'Markdown supported — bold, bullet lists, inline code.', az: 'Markdown dəstəklənir — qalın, siyahılar, sətir içi kod.' },
    'kb.lbl_tags': { en: 'Tags', az: 'Teqlər' },
    'kb.lbl_tags_help': { en: 'Comma-separated', az: 'Vergüllə ayrılmış' },
    'kb.lbl_source': { en: 'Further Reading (URL)', az: 'Əlavə Oxu (URL)' },
    'kb.lbl_your_name': { en: 'Your Name', az: 'Adınız' },
    'kb.lbl_your_email': { en: 'Your Email', az: 'E-poçtunuz' },
    'kb.btn_submit': { en: 'Submit Article', az: 'Məqaləni Göndər' },
    'kb.submit_note': { en: 'Reviewed within a few days.', az: 'Bir neçə gün ərzində yoxlanılır.' },
    'kb.via_issue': { en: 'Or submit via a GitHub issue', az: 'Və ya GitHub issue vasitəsilə göndərin' },
    'kb.sending': { en: 'Submitting…', az: 'Göndərilir…' },
    'kb.empty_featured_h': { en: 'No featured articles yet', az: 'Hələ seçilmiş məqalə yoxdur' },
    'kb.empty_featured_p': { en: 'Great submissions get featured here.', az: 'Yaxşı məqalələr burada seçilir.' },
    'kb.empty_h': { en: 'No articles yet', az: 'Hələ məqalə yoxdur' },
    'kb.empty_p': { en: 'Be the first to contribute a best practice below.', az: 'Aşağıda ilk ən yaxşı təcrübəni paylaşan siz olun.' },
    'kb.err_summary': { en: 'Summary is too short — describe the article in at least 20 characters.', az: 'Xülasə çox qısadır — məqaləni ən azı 20 simvolla təsvir edin.' },
    'kb.err_anon': { en: 'Please provide your name and email — or <a href="/login/">sign in</a>.', az: 'Zəhmət olmasa adınız və e-poçtunuzu yazın — və ya <a href="/login/">daxil olun</a>.' },
    'kb.err_no_rpc': { en: 'Submission service is not yet enabled on the server. Please submit via a GitHub issue for now.', az: 'Göndərmə xidməti hələ serverdə aktivləşməyib. Hazırda GitHub issue vasitəsilə göndərin.' },
    'kb.err_failed': { en: 'Submission failed:', az: 'Göndərmə alınmadı:' },
    'kb.err_net': { en: 'Network error. Please try again, or submit via a GitHub issue.', az: 'Şəbəkə xətası. Yenidən cəhd edin və ya GitHub issue vasitəsilə göndərin.' },
    'kb.ok_submitted': { en: '<i class="fas fa-check-circle"></i> Thanks! Your article has been submitted for review. We\'ll publish it once approved.', az: '<i class="fas fa-check-circle"></i> Təşəkkürlər! Məqaləniz qiymətləndirmə üçün göndərildi. Təsdiqdən sonra dərc ediləcək.' },
  };
