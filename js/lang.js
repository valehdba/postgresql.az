...
(function() {
  ...
  var T = {
    ...
    'coc.subtitle': { en: 'AZERPUG is committed to providing a welcoming, inclusive, and harassment-free experience for everyone. We explicitly adopt the <strong>PostgreSQL Community Code of Conduct</strong> as our own.', az: 'AZERPUG hər kəs üçün qonaqpərvər, inklüziv və təcavüzdən azad mühit təmin etməyə sadiqdir. Biz rəsmi <strong>PostgreSQL İcma Davranış Qaydalarını</strong> qəbul edirik.' },
    'coc.commitment_title': { en: 'Our Commitment', az: 'Öhdəliyimiz' },
    'coc.commitment_text': { en: 'As a recognized PostgreSQL User Group, AZERPUG fully adopts the official PostgreSQL Community Code of Conduct. This policy applies to all AZERPUG spaces — including meetups, events, online discussions, social media groups, and this website.', az: 'Tanınmış PostgreSQL İstifadəçi Qrupu olaraq, AZERPUG rəsmi PostgreSQL İcma Davranış Qaydalarını tam qəbul edir. Bu siyasət bütün AZERPUG məkanlarına — o cümlədən görüşlər, tədbirlər, onlayn müzakirələr, sosial media qrupları və bu veb sayta şamil edilir.' },
    ...
    'coc.scope_intro': { en: 'This Code of Conduct applies to all AZERPUG community spaces, including but not limited to:', az: 'Bu Davranış Qaydaları bütün AZERPUG icma məkanlarına şamil edilir, o cümlədən:' },
    'coc.scope_1': { en: 'In-person meetups, workshops, and conferences organized by AZERPUG', az: 'AZERPUG tərəfindən təşkil edilən canlı görüşlər, seminarlar və konfranslar' },
    'coc.scope_2': { en: 'The AZERPUG website (postgresql.az) — blog posts, comments, and contact messages', az: 'AZERPUG veb saytı (postgresql.az) — bloq yazıları, şərhlər və əlaqə mesajları' },
    'coc.scope_3': { en: 'AZERPUG social media groups (Facebook, LinkedIn, Telegram)', az: 'AZERPUG sosial media qrupları (Facebook, LinkedIn, Telegram)' },
    'coc.scope_4': { en: 'AZERPUG GitHub repositories and discussions', az: 'AZERPUG GitHub repoları və müzakirələri' },
    'coc.scope_5': { en: 'Any communication conducted in the context of AZERPUG community activities', az: 'AZERPUG icma fəaliyyəti kontekstində aparılan istənilən ünsiyyət' },
    ...
    'coc.reporting_pg': { en: 'You may also refer to the <a href="https://www.postgresql.org/about/policies/coc/committee/" target="_blank" rel="noopener" style="font-weight:700;">PostgreSQL Code of Conduct Committee</a> for guidance on the broader community process.', az: 'Daha geniş icma prosesi üzrə rəhbərlik üçün <a href="https://www.postgresql.org/about/policies/coc/committee/" target="_blank" rel="noopener" style="font-weight:700;">PostgreSQL Davranış Qaydaları Komitəsinə</a> də müraciət edə bilərsiniz.' },
