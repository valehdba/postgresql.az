...
(function() {
  ...
  var T = {
    ...
    'committees.principle_terms_h': { en: 'Limited Terms', az: 'Məhdud Vəzifə Müddəti' },
    'committees.principle_terms_p': { en: 'Committee members serve fixed terms (typically 1–2 years), with rotation to prevent entrenchment.', az: 'Komitə üzvləri müəyyən müddətə (adətən 1–2 il) xidmət edir, möhkəmlənmənin qarşısını almaq üçün rotasiya tətbiq olunur.' },
    ...
    'committees.principle_diverse_h': { en: 'Diverse Composition', az: 'Müxtəlif Tərkib' },
    'committees.principle_diverse_p': { en: 'Members are drawn from different companies and backgrounds; no single employer holds a majority on any committee.', az: 'Üzvlər müxtəlif şirkət və sahələrdən cəlb olunur; heç bir tək işəgötürən komitədə çoxluq təşkil edə bilməz.' },
    ...
    'committees.coc_size': { en: '3 members', az: '3 üzv' },
    'committees.coc_term': { en: '1 year, renewable once', az: '1 il, bir dəfə uzadıla bilər' },
    'committees.coc_composition': { en: 'Lead, Diversity Member, External Reviewer', az: 'Lider, Müxtəliflik Üzvü, Kənar Reviewer' },
    ...
    'committees.program_size': { en: '5–7 members', az: '5–7 üzv' },
    'committees.program_term': { en: 'Per event cycle (with renewal)', az: 'Hər tədbir dövrü üçün (uzadıla bilər)' },
    ...
    'committees.organizing_size': { en: '4–8 members', az: '4–8 üzv' },
    'committees.organizing_term': { en: 'Per event, rolling', az: 'Hər tədbir üçün, davamlı' },
    ...
    'committees.advocacy_size': { en: '3–5 members', az: '3–5 üzv' },
    'committees.advocacy_term': { en: '1 year, renewable', az: '1 il, uzadıla bilər' },
    ...
    'committees.seat_volunteer': { en: 'Volunteer Lead', az: 'Könüllülər Lideri' },
    ...
    'committees.coc_seat_lead_desc': { en: 'Coordinates the committee, ensures process is followed, primary point of contact.', az: 'Komitəni koordinasiya edir, prosesin gözlənilməsini təmin edir, əsas əlaqə nöqtəsidir.' },
    ...
    'committees.program_seat_chair_desc': { en: 'Runs the CFP, schedules review rounds, breaks ties.', az: 'CFP-ni idarə edir, qiymətləndirmə dövrlərini planlaşdırır, bərabər nəticələrdə qərar verir.' },
    ...
    'committees.org_seat_lead_desc': { en: 'Owns event delivery end-to-end; runs run-of-show and budget.', az: 'Tədbirin başdan-sona icrasına məsuldur; ssenari və büdcəni idarə edir.' },
    'committees.org_seat_logistics_desc': { en: 'Venue, catering, A/V, signage, on-site coordination.', az: 'Məkan, qida, A/V, tablo, hadisə günü koordinasiya.' },
    ...
    'committees.adv_seat_lead_desc': { en: 'Owns AZERPUG voice and brand; sets channel strategy.', az: 'AZERPUG-ın səsi və brendi üçün məsuldur; kanal strategiyasını müəyyən edir.' },
    ...
    'apply.opt_coc_lead': { en: 'Lead', az: 'Lider' },
    ...
    'apply.hint_coc_seat': { en: 'Recommended composition: 3 members — Lead, Diversity, External.', az: 'Tövsiyə olunan tərkib: 3 üzv — Lider, Müxtəliflik, Kənar.' },
